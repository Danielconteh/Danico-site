...
module.exports = {
  ...
  plugins: [
    ...
    // ANIMATION SECTION PLUGIN
    {
      ...
      options: {
        threshold: 0.65, // Percentage of an element's area that needs to be visible to launch animation
        ...
        rootMargin: '-250px 0px 0px 0px', // Corresponds to root's bounding box margin
